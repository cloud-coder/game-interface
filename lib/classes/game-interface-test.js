...
//      test.xexample('multiple instances are deep equal', true, function () {
//        return (Tequila() === Tequila() && Tequila() === new Tequila());
//      });
//      test.xexample('A reference is available internally to all modules in the library "T"', true, function () {
//        return T === Tequila();
//      });
//    });
