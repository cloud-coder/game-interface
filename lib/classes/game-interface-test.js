...
test.runnerGameInterface = function () {
  test.heading('GameInterface Singleton', function () {
    ...
    test.heading('METHODS', function () {
      ...
      test.heading('initializeEnvironment', function () {
        test.paragraph('Initialize environment is used to prepare resources.');
        test.example('callBack property required', Error('callBack property required'), function () {
          I.initializeEnvironment();
        });
        test.example('canvasID (string ID element in html) property required', Error('canvasID property required'), function () {
          I.initializeEnvironment({callBack: function () {
          }});
        });
      });
