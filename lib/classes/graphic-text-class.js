...
function GraphicText(args) {
  this.properties = ['viewPort', 'visible', 'x', 'y', 'width', 'height', 'text', 'lineWrap', 'font', 'textAlign', 'color'];
  this.text = '';
  this.textAlign = 'left';
...
GraphicText.prototype._cjsUpdateProperties = function () {
  ...
  this.cjs.text.width = this.width;
  this.cjs.text.textAlign = this.textAlign;
  this.cjs.text.color = this.color;
  if (this.lineWrap) {
